...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Revolution.AllInfoCar();
  });
  ...
  describe('AllInfoCar', function() {
    it('should create an instance of AllInfoCar', function() {
      // uncomment below and update the code to test AllInfoCar
      //var instane = new Revolution.AllInfoCar();
      //expect(instance).to.be.a(Revolution.AllInfoCar);
    });
